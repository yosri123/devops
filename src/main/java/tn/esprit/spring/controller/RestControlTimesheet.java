...
public class RestControlTimesheet {
	...
	@ResponseBody
	public Long ajouterMission(@RequestBody Mission mission) {
		itimesheetservice.ajouterMission(mission);
		return mission.getId();
	}

	@PutMapping(value = "/affecterMissionADepartement/{idmission}/{iddept}") 
	public void affecterMissionADepartement(@PathVariable("idmission") Long missionId, @PathVariable("iddept") int depId) {
	...
	@ResponseBody
	public void ajouterTimesheet(@PathVariable("idmission") Long missionId, @PathVariable("idemp") int employeId, @PathVariable("dated") Date dateDebut,@PathVariable("datef") Date dateFin) {
    ...
    @ResponseBody
	public List<Employe> getAllEmployeByMission(@PathVariable("idmission") Long missionId) {
